...
<nav style="font-size:12px" class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
    <div class="container">
        <a style="color:#fff" href="/inventarios/home.php"><img src="/inventarios/assets/img/logo-invert.svg" width="40px" alt="" srcset=""></a>
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="/inventarios/home.php">Inicio</a>
            </li>
        ...
        <div class="form-inline my-2 my-lg-0">
            <ul class="navbar-nav mr-auto">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="/inventarios/php/cerrar_sesion.php">Cerrar sesión</a>
                </div>
                </li>
            </ul>
        </div>
  ...
  function permisos(modulo) {
        ...
        type : 'POST',
        data: values,
        url: '/inventarios/php/sel_menu.php',
        beforeSend: function() {
            ...
            if (obj.success) {
                $.each(obj.resultado, function( index, val ) {
                    if (val.restriccion !== "0") {
                        ...
                        window.location.href = '/inventarios/home.php';
                    }                
                });    
            }else{
                alert("Usted no posee permisos para esta acción")
  ...
  function cuentas(bodega) {
        ...
        type : 'POST',
        data: values,
        url: '/inventarios/php/caja/seleccionar.php',
        beforeSend: function() {
            //$(".loader").css("display", "inline-block")
        },
        success: function(respuesta) {
  ...
  function buscar_bodegas() {
    let values = { 
        ...
        type : 'POST',
        data: values,
        url: '/inventarios/php/bodega/seleccionar.php',
        beforeSend: function() {
            //$(".loader").css("display", "inline-block")
        },
        success: function(respuesta) {
  ...
  function buscar_proveedores(param) {
    let values = { 
        ...
        type : 'POST',
        data: values,
        url: '/inventarios/php/proveedor/seleccionar.php',
        beforeSend: function() {
            //$(".loader").css("display", "inline-block")
        },
        success: function(respuesta) {
