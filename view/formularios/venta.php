...
$(function() {
  ...
  function guardar_detalle_factura() {
      ...
      $.ajax({
        ...
        url: '/inventarios/php/facturacion/guardar_detalle_factura.php',
    ...
    function eliminar_detalle_factura(id) {
        ...
        type : 'POST',
        data: values,
        url: '/inventarios/php/facturacion/eliminar.php',
        success: function(respuesta) {
          let obj = JSON.parse(respuesta)
          if (obj.numero == 1) {
    ...
    function Showventa() {
        ...
        type : 'POST',
        data: values,
        url: '/inventarios/php/facturacion/seleccionar.php',
        beforeSend: function() {
  ...
  function guardar_factura() {
    ...
    if (productos.length == 0) {
      ...
      $.ajax({
        type : 'POST',
        data: values,
        url: '/inventarios/php/facturacion/guardar_factura.php',
        success: function(respuesta) {
          let obj = JSON.parse(respuesta)
          if (obj.success) {
