                    ...
                    <div class="card-body">
                        <form class="form" id="form_actualizar" role="form" onsubmit="event.preventDefault(); return actualizar_cliente();" autocomplete="off">
                            ...
                            <div style="display:none" class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control form-control-sm" required name="alias1" type="text" placeholder="Nombre de tienda">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="card-body">
                        <form class="form" id="form_guardar" role="form" methods="POST" onsubmit="event.preventDefault(); return guardar_cliente();" autocomplete="off">
                            <div class="container">
                                ...
                                <div class="form-group">
                                    <input class="form-control form-control-sm" required name="alias" type="text" placeholder="Nombre de tienda">
                                </div>
                                <div class="form-group">
...
$(function() {
  ...
  function guardar_cliente() {
      $.ajax({
        ...
        url: '/inventarios/php/cliente/guardar.php',
    ...
    function actualizar_cliente() {
      $.ajax({
        ...
        url: '/inventarios/php/cliente/actualizar.php',
        success: function(respuesta) {
          let obj = JSON.parse(respuesta)
          if (obj.success) {
    ...
    function Showcliente() {
        ...
        $(".editar").click(function() {
            ...
            $("input[name*='alias1']").val(valores[3])
            $("input[name*='direccion1']").val(valores[4])
            $("input[name*='telefono1']").val(valores[5])
            $("input[name*='email1']").val(valores[6])
            $("select[name*='state1']").val(valores[7])
        })
