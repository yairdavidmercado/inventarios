  ...
  <div class="py-5 bg-white rounded shadow-sm">
    ...
    <div class="row">
            ...
            <div class="col-sm-9">
                <div class="card">
                    <div class="card-header">
                    <!-- <a class="btn btn-danger float-right btn-sm" target="_blank" href="/inventarios/reports/usuarios.php" type="submit"><i class="fa fa-file-pdf-o" style="font-size:18px" ></i></a> -->
...
$(function() {
  ...
  function guardar_usuario() {
      ...
      $.ajax({
        ...
        url: '/inventarios/php/usuario/guardar.php',
    ...
    function actualizar_usuario() {
      ...
      $.ajax({
        ...
        url: '/inventarios/php/usuario/actualizar.php',
        success: function(respuesta) {
          let obj = JSON.parse(respuesta)
          if (obj.success) {
    ...
    function Showusuario() {
        ...
        type : 'POST',
        data: values,
        url: '/inventarios/php/usuario/seleccionar.php',
        beforeSend: function() {
