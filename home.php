          ...
          <img width="100%" src="assets/img/devolucion-proveedores.jpg" alt="">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                <a  href="view/formularios/orden_pedido.php" class="btn btn-sm" style="background-color: #6c63ff; color:#fff">Orden de pedido</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-2">
          ...
          <img width="100%" src="assets/img/search.jpg" alt="">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                <a  href="view/formularios/ver_orden_pedido.php" class="btn btn-sm" style="background-color: #6c63ff; color:#fff">Registros de pedidos</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-2">
          ...
          <img width="100%" src="assets/img/buy-proveedores.jpg" alt="">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                <a  href="view/formularios/compra_proveedor.php" class="btn btn-sm" style="background-color: #6c63ff; color:#fff">Comprar a proveedores</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-2">
          ...
          <img width="100%" src="assets/img/calendar.jpg" alt="">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                <a  href="view/formularios/categoria.php" class="btn btn-sm" style="background-color: #6c63ff; color:#fff">Crear categoria</a>
                </div>
              </div>
            </div>
          </div>
